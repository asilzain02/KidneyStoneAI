"""
evaluate_exp15.py — EXP15 external evaluation.
INFERENCE ONLY.
"""
...
def main():
    ...
    parser.add_argument("--checkpoint", type=str, default=str(_OUT_DIR/"checkpoints"/"best_model_exp15_b2_320.pth"))
    ...
    model = build_exp15_model(cfg); model.load_state_dict(torch.load(ckpt_path, map_location=device)["model_state_dict"])
    ...
    with open(_METRICS_DIR/"external_results.json","w",encoding="utf-8") as f: json.dump({"experiment":"EXP15","metrics":metrics,"baseline":BASE}, f, indent=2)
